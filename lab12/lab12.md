...
​		这样来看，`ASCII`码的范围就在100-103之间了，我们一个一个测试即可。我们首先输入`1' and Ascii(Substr(database(),1,1))=100 #`，发现数据库显示存在，说明我们第一个字母的`ASCII`值就是100，即小写字母d。![屏幕截图 2025-05-29 235407](D:\Desktop\软件安全\实验\lab12\屏幕截图 2025-05-29 235407.png)
